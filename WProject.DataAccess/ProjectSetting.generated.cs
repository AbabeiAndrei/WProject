...
namespace WProject.DataAccess	
{
	...
	public partial class ProjectSetting : INotifyPropertyChanging, INotifyPropertyChanged
	{
		private int _id;
		...
		[ForeignKeyAssociation(ConstraintName = "project_setting_project_FK_project_id", SharedFields = "ProjectId", TargetFields = "Id")]
		[Storage("_project")]
		...
		private User _user;
		[ForeignKeyAssociation(ConstraintName = "project_setting_user_FK_last_updated_by", SharedFields = "LastUpdatedBy", TargetFields = "Id")]
		[Storage("_user")]
