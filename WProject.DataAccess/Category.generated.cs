...
namespace WProject.DataAccess	
{
	...
	public partial class Category : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		[Column("spring_id", OpenAccessType = OpenAccessType.Int32, Length = 0, Scale = 0, SqlType = "integer")]
		[Storage("_springId")]
		[System.ComponentModel.DataAnnotations.Required()]
		public virtual int SpringId
		{
			get
			{
			...
			set
			{
				if(this._springId != value)
				{
					this.OnPropertyChanging("SpringId");
					this._springId = value;
					this.OnPropertyChanged("SpringId");
				}
			}
		}
		...
		[ForeignKeyAssociation(ConstraintName = "category_category_FK_parent_id", SharedFields = "ParentId", TargetFields = "Id")]
		[Storage("_category1")]
		...
		[ForeignKeyAssociation(ConstraintName = "category_spring_FK_spring_id", SharedFields = "SpringId", TargetFields = "Id")]
		[Storage("_spring")]
		public virtual Spring Spring
		{
			get
			{
				return this._spring;
			...
			set
			{
				...
				{
					this.OnPropertyChanging("Spring");
					this._spring = value;
					this.OnPropertyChanged("Spring");
				}
			}
		}
		
		private User _user;
		[ForeignKeyAssociation(ConstraintName = "category_user_FK_created_by", SharedFields = "CreatedById", TargetFields = "Id")]
		[Storage("_user")]
		...
		private User _user1;
		[ForeignKeyAssociation(ConstraintName = "category_user_FK_owner_id", SharedFields = "OwnerId", TargetFields = "Id")]
		[Storage("_user1")]
		...
		[Storage("_categories")]
		public virtual IList<Category> Subategories
		{
			get
			{
